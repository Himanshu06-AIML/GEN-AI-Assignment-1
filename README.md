...
| Field | Details |
| :--- | :--- |
| **Student Name** | **Himanshu Gharde** |
| **PRN Number** | **202401110007** |
| **Batch** | **A1** |
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Himanshu06-AIML/GEN-AI-Assignment-1.git
   cd GEN-AI-Assignment-1
   ```
2. Launch Jupyter Notebook:
   ```bash
   jupyter notebook Himanshu_Gharde_GenerativeAILabAssignment.ipynb
   ```
